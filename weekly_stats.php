...
<html>
	...
	<body>
		...
		while ($row = $result2->fetch_assoc()) {
			...
			$query = "SELECT COUNT(year) as count FROM paid_orders WHERE paid_orders.box_content like '%".$res."%' AND (  timestamp LIKE '%03/26/2018%' OR timestamp LIKE '%03/27/2018%' OR timestamp LIKE '%03/28/2018%' )";
		...
		$query_full_snack = "SELECT COUNT(year) as count FROM paid_orders WHERE (lower(paid_orders.package) like '%full%' AND lower(paid_orders.package) like '%1%') AND ( timestamp LIKE '%10/22/2018%' OR timestamp LIKE '%10/23/2018%' OR timestamp LIKE '%10/24/2018%'  )";
		$query_full_produce = "SELECT COUNT(year) as count FROM paid_orders WHERE (lower(paid_orders.package) like '%full%' AND lower(paid_orders.package) like '%2%') AND ( timestamp LIKE '%10/22/2018%' OR timestamp LIKE '%10/23/2018%' OR timestamp LIKE '%10/24/2018%' )";
		$query_half_snack = "SELECT COUNT(year) as count FROM paid_orders WHERE (lower(paid_orders.package) like '%half%' AND lower(paid_orders.package) like '%1%') AND ( timestamp LIKE '%10/22/2018%' OR timestamp LIKE '%10/23/2018%' OR timestamp LIKE '%10/24/2018%'  )";
		$query_half_produce = "SELECT COUNT(year) as count FROM paid_orders WHERE (lower(paid_orders.package) like '%half%' AND lower(paid_orders.package) like '%2%') AND (timestamp LIKE '%10/22/2018%' OR timestamp LIKE '%10/23/2018%' OR timestamp LIKE '%10/24/2018%' )";
