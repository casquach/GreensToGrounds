...
<html>
	...
	<body>
		...
		$sql = "SELECT * FROM unpaid_orders WHERE timestamp LIKE '%3/25/2019%' OR timestamp LIKE '%3/26/2019%' OR timestamp LIKE '%3/27/2019%'  AND name != '' AND lower(unpaid_orders.name) NOT LIKE '%test%' ORDER BY `unpaid_orders`.`timestamp` ASC";
