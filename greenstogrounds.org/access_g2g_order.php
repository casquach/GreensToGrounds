...
<html>
	...
	<body>
		<center>
			...
			<h1 style="color:green; border-style:solid"> Access G2G orders </h1>
		</center>
		...
		$sql = "SELECT * FROM plusdollars_orders WHERE timestamp LIKE '%03/26/2018%' OR timestamp LIKE '%03/27/2018%' OR timestamp LIKE '%03/28/2018%'";
