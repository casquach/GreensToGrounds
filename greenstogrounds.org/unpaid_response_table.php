...
<html>
	...
	<body>
		...
		$sql = "SELECT * FROM unpaid_orders WHERE timestamp LIKE '%09/16/2019%' OR timestamp LIKE '%09/17/2019%' OR timestamp LIKE '%09/18/2019%'  AND name != '' AND lower(unpaid_orders.name) NOT LIKE '%test%' ORDER BY `unpaid_orders`.`timestamp` ASC";
