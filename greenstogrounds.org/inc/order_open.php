...
?>
<!-- <span class="order-form-questions" style="font-weight: bold;">Please input the discount code first! The page will refresh once it is submitted and remove all inputted data.</span> -->
