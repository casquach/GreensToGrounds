...
session_start();
	...
	<body>
		...
		if (true){
			...
			$sql3 = "SELECT COUNT(year)  FROM paid_orders WHERE paid_orders.year like '%1st%' AND ( timestamp LIKE '%10/14/2019%' OR timestamp LIKE '%10/15/2019%' OR timestamp LIKE '%10/16/2019%')";
			$sql4 = "SELECT COUNT(year)  FROM paid_orders WHERE paid_orders.year like '%2nd%' AND ( timestamp LIKE '%10/14/2019%' OR timestamp LIKE '%10/15/2019%' OR timestamp LIKE '%10/16/2019%')";
			$sql5 = "SELECT COUNT(year)  FROM paid_orders WHERE paid_orders.year like '%3rd%' AND (timestamp LIKE '%10/14/2019%' OR timestamp LIKE '%10/15/2019%' OR timestamp LIKE '%10/16/2019%')";
			$sql6 = "SELECT COUNT(year)  FROM paid_orders WHERE paid_orders.year like '%4th%' AND (timestamp LIKE '%10/14/2019%' OR timestamp LIKE '%10/15/2019%' OR timestamp LIKE '%10/16/2019%')";
			$sql7 = "SELECT COUNT(year)  FROM paid_orders WHERE (paid_orders.year NOT LIKE '%1st%' AND paid_orders.year NOT LIKE '%2nd%' AND paid_orders.year NOT LIKE '%3rd%' AND paid_orders.year NOT LIKE '%4th%') AND ( timestamp LIKE '%10/14/2019%' OR timestamp LIKE '%10/15/2019%' OR timestamp LIKE '%10/16/2019%')";
			...
			print "<tr>\n";
			print "<td>Fall '19</td>";
			print "<td>(10/14/2019-10/16/2019) </td>";
		...
		if (true){
			$sql = "SELECT COUNT(*) as count FROM paid_orders WHERE timestamp LIKE '%10/07/2019%' OR timestamp LIKE '%10/08/2019%' OR timestamp LIKE '%10/09/2019%' AND name != '' AND lower(paid_orders.name) NOT LIKE '%test%' ORDER BY `paid_orders`.`timestamp` DESC";
			$plusSql = "SELECT COUNT(*) FROM plusdollars_orders WHERE timestamp LIKE '%10/07/2019%' OR timestamp LIKE '%10/08/2019%' OR timestamp LIKE '%10/09/2019%'";
			$sql2 = "SELECT SUM(cost) as sum FROM paid_orders WHERE timestamp LIKE '%10/07/2019%' OR timestamp LIKE '%10/08/2019%' OR timestamp LIKE '%10/09/2019%' AND name != '' AND lower(paid_orders.name) NOT LIKE '%test%' ORDER BY `paid_orders`.`timestamp` DESC";
			$sql3 = "SELECT COUNT(year)  FROM paid_orders WHERE paid_orders.year like '%1st%' AND ( timestamp LIKE '%10/07/2019%' OR timestamp LIKE '%10/08/2019%' OR timestamp LIKE '%10/09/2019%')";
			$sql4 = "SELECT COUNT(year)  FROM paid_orders WHERE paid_orders.year like '%2nd%' AND ( timestamp LIKE '%10/07/2019%' OR timestamp LIKE '%10/08/2019%' OR timestamp LIKE '%10/09/2019%')";
			$sql5 = "SELECT COUNT(year)  FROM paid_orders WHERE paid_orders.year like '%3rd%' AND (timestamp LIKE '%10/07/2019%' OR timestamp LIKE '%10/08/2019%' OR timestamp LIKE '%10/09/2019%')";
			$sql6 = "SELECT COUNT(year)  FROM paid_orders WHERE paid_orders.year like '%4th%' AND (timestamp LIKE '%10/07/2019%' OR timestamp LIKE '%10/08/2019%' OR timestamp LIKE '%10/09/2019%')";
			$sql7 = "SELECT COUNT(year)  FROM paid_orders WHERE (paid_orders.year NOT LIKE '%1st%' AND paid_orders.year NOT LIKE '%2nd%' AND paid_orders.year NOT LIKE '%3rd%' AND paid_orders.year NOT LIKE '%4th%') AND ( timestamp LIKE '%10/07/2019%' OR timestamp LIKE '%10/08/2019%' OR timestamp LIKE '%10/09/2019%')";
			...
			print "<tr>\n";
			print "<td>Fall '19</td>";
			print "<td>(10/07/2019-10/09/2019) </td>";
		...
		if (true){
			$sql = "SELECT COUNT(*) as count FROM paid_orders WHERE timestamp LIKE '%09/23/2019%' OR timestamp LIKE '%09/24/2019%' AND name != '' AND lower(paid_orders.name) NOT LIKE '%test%' ORDER BY `paid_orders`.`timestamp` DESC";
			$plusSql = "SELECT COUNT(*) FROM plusdollars_orders WHERE timestamp LIKE '%09/23/2019%' OR timestamp LIKE '%09/24/2019%' OR timestamp LIKE '%09/25/2019%'";
			$sql2 = "SELECT SUM(cost) as sum FROM paid_orders WHERE timestamp LIKE '%09/23/2019%' OR timestamp LIKE '%09/24/2019%' AND name != '' AND lower(paid_orders.name) NOT LIKE '%test%' ORDER BY `paid_orders`.`timestamp` DESC";
			$sql3 = "SELECT COUNT(year)  FROM paid_orders WHERE paid_orders.year like '%1st%' AND ( timestamp LIKE '%09/23/2019%' OR timestamp LIKE '%09/24/2019%' OR timestamp LIKE '%09/25/2019%')";
			$sql4 = "SELECT COUNT(year)  FROM paid_orders WHERE paid_orders.year like '%2nd%' AND ( timestamp LIKE '%09/23/2019%' OR timestamp LIKE '%09/24/2019%' OR timestamp LIKE '%09/25/2019%')";
			$sql5 = "SELECT COUNT(year)  FROM paid_orders WHERE paid_orders.year like '%3rd%' AND (timestamp LIKE '%09/23/2019%' OR timestamp LIKE '%09/24/2019%' OR timestamp LIKE '%09/25/2019%')";
			$sql6 = "SELECT COUNT(year)  FROM paid_orders WHERE paid_orders.year like '%4th%' AND (timestamp LIKE '%09/23/2019%' OR timestamp LIKE '%09/24/2019%' OR timestamp LIKE '%09/25/2019%')";
			$sql7 = "SELECT COUNT(year)  FROM paid_orders WHERE (paid_orders.year NOT LIKE '%1st%' AND paid_orders.year NOT LIKE '%2nd%' AND paid_orders.year NOT LIKE '%3rd%' AND paid_orders.year NOT LIKE '%4th%') AND ( timestamp LIKE '%09/23/2019%' OR timestamp LIKE '%09/24/2019%' OR timestamp LIKE '%09/25/2019%')";
			...
			print "<tr>\n";
			print "<td>Fall '19</td>";
			print "<td>(09/23/2019-09/25/2019) </td>";
		...
		if (true){
			$sql = "SELECT COUNT(*) as count FROM paid_orders WHERE timestamp LIKE '%09/16/2019%' OR timestamp LIKE '%09/17/2019%' AND name != '' AND lower(paid_orders.name) NOT LIKE '%test%' ORDER BY `paid_orders`.`timestamp` DESC";
			$plusSql = "SELECT COUNT(*) FROM plusdollars_orders WHERE timestamp LIKE '%09/16/2019%' OR timestamp LIKE '%09/17/2019%' OR timestamp LIKE '%09/18/2019%'";
			$sql2 = "SELECT SUM(cost) as sum FROM paid_orders WHERE timestamp LIKE '%09/16/2019%' OR timestamp LIKE '%09/17/2019%' AND name != '' AND lower(paid_orders.name) NOT LIKE '%test%' ORDER BY `paid_orders`.`timestamp` DESC";
			$sql3 = "SELECT COUNT(year)  FROM paid_orders WHERE paid_orders.year like '%1st%' AND ( timestamp LIKE '%09/16/2019%' OR timestamp LIKE '%09/17/2019%' OR timestamp LIKE '%09/18/2019%')";
			$sql4 = "SELECT COUNT(year)  FROM paid_orders WHERE paid_orders.year like '%2nd%' AND ( timestamp LIKE '%09/16/2019%' OR timestamp LIKE '%09/17/2019%' OR timestamp LIKE '%09/18/2019%')";
			$sql5 = "SELECT COUNT(year)  FROM paid_orders WHERE paid_orders.year like '%3rd%' AND (timestamp LIKE '%09/16/2019%' OR timestamp LIKE '%09/17/2019%' OR timestamp LIKE '%09/18/2019%')";
			$sql6 = "SELECT COUNT(year)  FROM paid_orders WHERE paid_orders.year like '%4th%' AND (timestamp LIKE '%09/16/2019%' OR timestamp LIKE '%09/17/2019%' OR timestamp LIKE '%09/18/2019%')";
			$sql7 = "SELECT COUNT(year)  FROM paid_orders WHERE (paid_orders.year NOT LIKE '%1st%' AND paid_orders.year NOT LIKE '%2nd%' AND paid_orders.year NOT LIKE '%3rd%' AND paid_orders.year NOT LIKE '%4th%') AND ( timestamp LIKE '%09/16/2019%' OR timestamp LIKE '%09/17/2019%' OR timestamp LIKE '%09/18/2019%')";
			...
			print "<tr>\n";
			print "<td>Fall '19</td>";
			print "<td>(09/16/2019-09/18/2019) </td>";
		...
		if (true){
			$sql = "SELECT COUNT(*) as count FROM paid_orders WHERE timestamp LIKE '%09/10/2019%' OR timestamp LIKE '%09/11/2019%' AND name != '' AND lower(paid_orders.name) NOT LIKE '%test%' ORDER BY `paid_orders`.`timestamp` DESC";
			$plusSql = "SELECT COUNT(*) FROM plusdollars_orders WHERE timestamp LIKE '%09/10/2019%' OR timestamp LIKE '%09/11/2019%'";
			$sql2 = "SELECT SUM(cost) as sum FROM paid_orders WHERE timestamp LIKE '%09/10/2019%' OR timestamp LIKE '%09/11/2019%' AND name != '' AND lower(paid_orders.name) NOT LIKE '%test%' ORDER BY `paid_orders`.`timestamp` DESC";
			$sql3 = "SELECT COUNT(year)  FROM paid_orders WHERE paid_orders.year like '%1st%' AND ( timestamp LIKE '%09/10/2019%' OR timestamp LIKE '%09/11/2019%')";
			$sql4 = "SELECT COUNT(year)  FROM paid_orders WHERE paid_orders.year like '%2nd%' AND ( timestamp LIKE '%09/10/2019%' OR timestamp LIKE '%09/11/2019%')";
			$sql5 = "SELECT COUNT(year)  FROM paid_orders WHERE paid_orders.year like '%3rd%' AND (timestamp LIKE '%09/10/2019%' OR timestamp LIKE '%09/11/2019%')";
			$sql6 = "SELECT COUNT(year)  FROM paid_orders WHERE paid_orders.year like '%4th%' AND (timestamp LIKE '%09/10/2019%' OR timestamp LIKE '%09/11/2019%')";
			$sql7 = "SELECT COUNT(year)  FROM paid_orders WHERE (paid_orders.year NOT LIKE '%1st%' AND paid_orders.year NOT LIKE '%2nd%' AND paid_orders.year NOT LIKE '%3rd%' AND paid_orders.year NOT LIKE '%4th%') AND ( timestamp LIKE '%09/10/2019%' OR timestamp LIKE '%09/11/2019%')";
			...
			print "<tr>\n";
			print "<td>Fall '19</td>";
			print "<td>(09/09/2019-09/11/2019) </td>";
		...
		if (true){
			...
			print "<tr>\n";
			print "<td>Spring '19</td>";
			print "<td>(3/25/2019-3/27/2019) </td>";
		...
		if (true){
			$sql = "SELECT COUNT(*) as count FROM paid_orders WHERE timestamp LIKE '%04/01/2019%' OR timestamp LIKE '%04/02/2019%' OR timestamp LIKE '%04/03/2019%' AND name != '' AND lower(paid_orders.name) NOT LIKE '%test%' ORDER BY `paid_orders`.`timestamp` DESC";
			$plusSql = "SELECT COUNT(*) FROM plusdollars_orders WHERE timestamp LIKE '%04/01/2019%' OR timestamp LIKE '%04/02/2019%' OR timestamp LIKE '%04/03/2019%'";
			$sql2 = "SELECT SUM(cost) as sum FROM paid_orders WHERE timestamp LIKE '%04/01/2019%' OR timestamp LIKE '%04/02/2019%' OR timestamp LIKE '%04/03/2019%' AND name != '' AND lower(paid_orders.name) NOT LIKE '%test%' ORDER BY `paid_orders`.`timestamp` DESC";
			$sql3 = "SELECT COUNT(year)  FROM paid_orders WHERE paid_orders.year like '%1st%' AND ( timestamp LIKE '%04/01/2019%' OR timestamp LIKE '%04/02/2019%' OR timestamp LIKE '%04/03/2019%')";
			$sql4 = "SELECT COUNT(year)  FROM paid_orders WHERE paid_orders.year like '%2nd%' AND ( timestamp LIKE '%04/01/2019%' OR timestamp LIKE '%04/02/2019%' OR timestamp LIKE '%04/03/2019%')";
			$sql5 = "SELECT COUNT(year)  FROM paid_orders WHERE paid_orders.year like '%3rd%' AND (timestamp LIKE '%04/01/2019%' OR timestamp LIKE '%04/02/2019%' OR timestamp LIKE '%04/03/2019%')";
			$sql6 = "SELECT COUNT(year)  FROM paid_orders WHERE paid_orders.year like '%4th%' AND (timestamp LIKE '%04/01/2019%' OR timestamp LIKE '%04/02/2019%' OR timestamp LIKE '%04/03/2019%')";
			$sql7 = "SELECT COUNT(year)  FROM paid_orders WHERE (paid_orders.year NOT LIKE '%1st%' AND paid_orders.year NOT LIKE '%2nd%' AND paid_orders.year NOT LIKE '%3rd%' AND paid_orders.year NOT LIKE '%4th%') AND ( timestamp LIKE '%04/01/2019%' OR timestamp LIKE '%04/02/2019%' OR timestamp LIKE '%04/03/2019%')";
		...
		if (true){
			$sql = "SELECT COUNT(*) as count FROM paid_orders WHERE timestamp LIKE '%04/08/2019%' OR timestamp LIKE '%04/09/2019%' OR timestamp LIKE '%04/10/2019%' AND name != '' AND lower(paid_orders.name) NOT LIKE '%test%' ORDER BY `paid_orders`.`timestamp` DESC";
			$plusSql = "SELECT COUNT(*) FROM plusdollars_orders WHERE timestamp LIKE '%04/08/2019%' OR timestamp LIKE '%04/09/2019%' OR timestamp LIKE '%04/10/2019%'";
			$sql2 = "SELECT SUM(cost) as sum FROM paid_orders WHERE timestamp LIKE '%04/08/2019%' OR timestamp LIKE '%04/09/2019%' OR timestamp LIKE '%04/10/2019%' AND name != '' AND lower(paid_orders.name) NOT LIKE '%test%' ORDER BY `paid_orders`.`timestamp` DESC";
			$sql3 = "SELECT COUNT(year)  FROM paid_orders WHERE paid_orders.year like '%1st%' AND ( timestamp LIKE '%04/08/2019%' OR timestamp LIKE '%04/09/2019%' OR timestamp LIKE '%04/10/2019%')";
			$sql4 = "SELECT COUNT(year)  FROM paid_orders WHERE paid_orders.year like '%2nd%' AND ( timestamp LIKE '%04/08/2019%' OR timestamp LIKE '%04/09/2019%' OR timestamp LIKE '%04/10/2019%')";
			$sql5 = "SELECT COUNT(year)  FROM paid_orders WHERE paid_orders.year like '%3rd%' AND (timestamp LIKE '%04/08/2019%' OR timestamp LIKE '%04/09/2019%' OR timestamp LIKE '%04/10/2019%')";
			$sql6 = "SELECT COUNT(year)  FROM paid_orders WHERE paid_orders.year like '%4th%' AND (timestamp LIKE '%04/08/2019%' OR timestamp LIKE '%04/09/2019%' OR timestamp LIKE '%04/10/2019%')";
			$sql7 = "SELECT COUNT(year)  FROM paid_orders WHERE (paid_orders.year NOT LIKE '%1st%' AND paid_orders.year NOT LIKE '%2nd%' AND paid_orders.year NOT LIKE '%3rd%' AND paid_orders.year NOT LIKE '%4th%') AND ( timestamp LIKE '%04/08/2019%' OR timestamp LIKE '%04/09/2019%' OR timestamp LIKE '%04/10/2019%')";
			...
			print "<tr>\n";
			print "<td>Spring '19</td>";
			print "<td>(4/8/2019-4/10/2019) </td>";
		...
		if (true){
			$sql = "SELECT COUNT(*) as count FROM paid_orders WHERE timestamp LIKE '%04/15/2019%' OR timestamp LIKE '%04/16/2019%' OR timestamp LIKE '%04/17/2019%' AND name != '' AND lower(paid_orders.name) NOT LIKE '%test%' ORDER BY `paid_orders`.`timestamp` DESC";
			$plusSql = "SELECT COUNT(*) FROM plusdollars_orders WHERE timestamp LIKE '%04/15/2019%' OR timestamp LIKE '%04/16/2019%' OR timestamp LIKE '%04/17/2019%'";
			$sql2 = "SELECT SUM(cost) as sum FROM paid_orders WHERE timestamp LIKE '%04/15/2019%' OR timestamp LIKE '%04/16/2019%' OR timestamp LIKE '%04/10/2019%' AND name != '' AND lower(paid_orders.name) NOT LIKE '%test%' ORDER BY `paid_orders`.`timestamp` DESC";
			$sql3 = "SELECT COUNT(year)  FROM paid_orders WHERE paid_orders.year like '%1st%' AND ( timestamp LIKE '%04/15/2019%' OR timestamp LIKE '%04/16/2019%' OR timestamp LIKE '%04/17/2019%')";
			$sql4 = "SELECT COUNT(year)  FROM paid_orders WHERE paid_orders.year like '%2nd%' AND ( timestamp LIKE '%04/15/2019%' OR timestamp LIKE '%04/16/2019%' OR timestamp LIKE '%04/17/2019%')";
			$sql5 = "SELECT COUNT(year)  FROM paid_orders WHERE paid_orders.year like '%3rd%' AND (timestamp LIKE '%04/15/2019%' OR timestamp LIKE '%04/16/2019%' OR timestamp LIKE '%04/17/2019%')";
			$sql6 = "SELECT COUNT(year)  FROM paid_orders WHERE paid_orders.year like '%4th%' AND (timestamp LIKE '%04/15/2019%' OR timestamp LIKE '%04/16/2019%' OR timestamp LIKE '%04/17/2019%')";
			$sql7 = "SELECT COUNT(year)  FROM paid_orders WHERE (paid_orders.year NOT LIKE '%1st%' AND paid_orders.year NOT LIKE '%2nd%' AND paid_orders.year NOT LIKE '%3rd%' AND paid_orders.year NOT LIKE '%4th%') AND ( timestamp LIKE '%04/15/2019%' OR timestamp LIKE '%04/16/2019%' OR timestamp LIKE '%04/17/2019%')";
			...
			print "<tr>\n";
			print "<td>Spring '19</td>";
			print "<td>(4/15/2019-4/17/2019) </td>";
		...
		if (true){
			$sql = "SELECT COUNT(*) as count FROM paid_orders WHERE timestamp LIKE '%04/22/2019%' OR timestamp LIKE '%04/23/2019%' OR timestamp LIKE '%04/24/2019%' AND name != '' AND lower(paid_orders.name) NOT LIKE '%test%' ORDER BY `paid_orders`.`timestamp` DESC";
			$plusSql = "SELECT COUNT(*) FROM plusdollars_orders WHERE timestamp LIKE '%04/22/2019%' OR timestamp LIKE '%04/23/2019%' OR timestamp LIKE '%04/24/2019%'";
			$sql2 = "SELECT SUM(cost) as sum FROM paid_orders WHERE timestamp LIKE '%04/22/2019%' OR timestamp LIKE '%04/23/2019%' OR timestamp LIKE '%04/24/2019%' AND name != '' AND lower(paid_orders.name) NOT LIKE '%test%' ORDER BY `paid_orders`.`timestamp` DESC";
			$sql3 = "SELECT COUNT(year)  FROM paid_orders WHERE paid_orders.year like '%1st%' AND ( timestamp LIKE '%04/22/2019%' OR timestamp LIKE '%04/23/2019%' OR timestamp LIKE '%04/24/2019%')";
			$sql4 = "SELECT COUNT(year)  FROM paid_orders WHERE paid_orders.year like '%2nd%' AND ( timestamp LIKE '%04/22/2019%' OR timestamp LIKE '%04/23/2019%' OR timestamp LIKE '%04/24/2019%')";
			$sql5 = "SELECT COUNT(year)  FROM paid_orders WHERE paid_orders.year like '%3rd%' AND (timestamp LIKE '%04/22/2019%' OR timestamp LIKE '%04/23/2019%' OR timestamp LIKE '%04/24/2019%')";
			$sql6 = "SELECT COUNT(year)  FROM paid_orders WHERE paid_orders.year like '%4th%' AND (timestamp LIKE '%04/22/2019%' OR timestamp LIKE '%04/23/2019%' OR timestamp LIKE '%04/24/2019%')";
			$sql7 = "SELECT COUNT(year)  FROM paid_orders WHERE (paid_orders.year NOT LIKE '%1st%' AND paid_orders.year NOT LIKE '%2nd%' AND paid_orders.year NOT LIKE '%3rd%' AND paid_orders.year NOT LIKE '%4th%') AND ( timestamp LIKE '%04/22/2019%' OR timestamp LIKE '%04/23/2019%' OR timestamp LIKE '%04/24/2019%')";
			...
			print "<tr>\n";
			print "<td>Spring '19</td>";
			print "<td>(4/22/2019-4/24/2019) </td>";
		...
		if (true){
			$sql = "SELECT COUNT(*) as count FROM paid_orders WHERE timestamp LIKE '%04/29/2019%' OR timestamp LIKE '%04/30/2019%' OR timestamp LIKE '%05/01/2019%' AND name != '' AND lower(paid_orders.name) NOT LIKE '%test%' ORDER BY `paid_orders`.`timestamp` DESC";
			$plusSql = "SELECT COUNT(*) FROM plusdollars_orders WHERE timestamp LIKE '%04/29/2019%' OR timestamp LIKE '%04/30/2019%' OR timestamp LIKE '%05/01/2019%'";
			$sql2 = "SELECT SUM(cost) as sum FROM paid_orders WHERE timestamp LIKE '%04/29/2019%' OR timestamp LIKE '%04/30/2019%' OR timestamp LIKE '%05/01/2019%' AND name != '' AND lower(paid_orders.name) NOT LIKE '%test%' ORDER BY `paid_orders`.`timestamp` DESC";
			$sql3 = "SELECT COUNT(year)  FROM paid_orders WHERE paid_orders.year like '%1st%' AND ( timestamp LIKE '%04/29/2019%' OR timestamp LIKE '%04/30/2019%' OR timestamp LIKE '%05/01/2019%')";
			$sql4 = "SELECT COUNT(year)  FROM paid_orders WHERE paid_orders.year like '%2nd%' AND ( timestamp LIKE '%04/29/2019%' OR timestamp LIKE '%04/30/2019%' OR timestamp LIKE '%05/01/2019%')";
			$sql5 = "SELECT COUNT(year)  FROM paid_orders WHERE paid_orders.year like '%3rd%' AND (timestamp LIKE '%04/29/2019%' OR timestamp LIKE '%04/30/2019%' OR timestamp LIKE '%05/01/2019%')";
			$sql6 = "SELECT COUNT(year)  FROM paid_orders WHERE paid_orders.year like '%4th%' AND (timestamp LIKE '%04/29/2019%' OR timestamp LIKE '%04/30/2019%' OR timestamp LIKE '%05/01/2019%')";
			$sql7 = "SELECT COUNT(year)  FROM paid_orders WHERE (paid_orders.year NOT LIKE '%1st%' AND paid_orders.year NOT LIKE '%2nd%' AND paid_orders.year NOT LIKE '%3rd%' AND paid_orders.year NOT LIKE '%4th%') AND ( timestamp LIKE '%04/29/2019%' OR timestamp LIKE '%04/30/2019%' OR timestamp LIKE '%05/01/2019%')";
			...
			print "<tr>\n";
			print "<td>Spring '19</td>";
			print "<td>(4/29/2019-5/1/2019) </td>";
