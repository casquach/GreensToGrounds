...
<html>
	...
	<body>
		...
		$sql = "SELECT * FROM paid_orders WHERE timestamp LIKE '%03/18/2019%' OR timestamp LIKE '%03/19/2019%' OR timestamp LIKE '%03/20/2019%'  AND name != '' AND lower(paid_orders.name) NOT LIKE '%test%' ORDER BY `paid_orders`.`timestamp` DESC";
